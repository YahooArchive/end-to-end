...
e2e_build_extension() {
  ...
  $jscompile_e2e -o compiled -i "$SRC_EXT_DIR/ui/glass/compose_bootstrap.js" > "$BUILD_EXT_DIR/composeglass_binary.js"
  ...
  $jscompile_e2e -o compiled -i "$SRC_EXT_DIR/ui/prompt/yprompt.js" > "$BUILD_EXT_DIR/yprompt_binary.js"
  # compile css files
