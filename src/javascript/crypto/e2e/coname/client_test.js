...
var lookupProofSample = {
  ...
  'index_proof': 'KjGw6JX/3h2fWsF4SlXyvtz6fF8y1JdYXhL7OhlM+wx5Nkvq+3pWP8ahgy' +
      'mUAfyWR1JREtEz3XZu8Nylvps5C1jUrWa9ZPnXeMJaFf9XOJ0t1lGn5GTDm0vUUh4HPGl9',
  'ratifications': [{
    'head': 'Cn0KBXlhaG9vEN8FGiCBchrs7C1cZcx1bMWq4qO74XVxelpcJh605IuX2A00AiI' +
        'LCNWZ9LIFEOSA2GIqQODYH1RRrcVjIvtnqiqgOsJa9waJwuIhpAvZB/jgngTFStZQ5v' +
        '6ewMxOLtaC2r4XEq4CLcyV5vC7C6o3DEAI6vsyABILCNWZ9LIFEOSA2GI=',
    'signatures': {
      '5004056709842995553': 'DrTsY0og0TV3t0ulFZRgiWn/J4WkVtUJTnMCIPFP+08Qzt' +
          '6Zvxci8FsovEh5NNa3ms/0WL6bus/04o9suSZLAQ=='
    }
  }, {
    'head': 'Cn0KBXlhaG9vEN8FGiCBchrs7C1cZcx1bMWq4qO74XVxelpcJh605IuX2A00AiI' +
        'LCNWZ9LIFEOSA2GIqQODYH1RRrcVjIvtnqiqgOsJa9waJwuIhpAvZB/jgngTFStZQ5v' +
        '6ewMxOLtaC2r4XEq4CLcyV5vC7C6o3DEAI6vsyABILCNWZ9LIFEOSA2GI=',
    'signatures': {
      '16574727844889599213': '9hDUnSxRlohxBJ475jKEVrq6DUqEvrnkUJsbXUIOjFg7R' +
          'qjyHa3PeXPKY1TN6G8Y8QS77AIt762jLDKYKIUSDA=='
    }
  }, {
    'head': 'Cn0KBXlhaG9vEN8FGiCBchrs7C1cZcx1bMWq4qO74XVxelpcJh605IuX2A00AiI' +
        'LCNWZ9LIFEOSA2GIqQODYH1RRrcVjIvtnqiqgOsJa9waJwuIhpAvZB/jgngTFStZQ5v' +
        '6ewMxOLtaC2r4XEq4CLcyV5vC7C6o3DEAI6vsyABILCNWZ9LIFEOSA2GI=',
    'signatures': {
      '1702327623518731708': 'rioH0nqY9H2YFgC7OJ9zPIpbsz3sLIKyM2YngAzGPGqbQR' +
          'q/JE9JLHAfBtbeeV+7ZIwum41nkG3Z7GXVSlwiCA=='
    }
  }],
  'tree_proof': {
    'neighbors': [
      'Aj2/iia09hdY9M15RG/mYwIJuuvo5uEzBGiu5WTsF1Q=',
      'uHZAo3zIZNmrlvCIVokRuMdBVHGqJ88qdDG4MnbJhpw='],
  ...
  'entry': 'CiBqMGw5oRM8tb9NNJGVMONJ6WY7Fv3ulqEXve0L5AGpdhAPGgISACJAn/J0QwWL' +
      '5BE881CrCHUbXWKul6V2dqTHRY+SCWLoFXAQOjOAZCZgLcffUZJSiHQxHcKFWVz+/r3NL' +
      'lIWih5g5Q==',
  'profile': 'ChC3v0QNmzruiHUB2gxenAdfEg4KA2FiYxIHZm9vIGJhchIPCgN4eXoSCFRFU1' +
      'QgNDU2'
};
...
var lookupProofNoBodySample = {
  ...
  'index_proof': 'Xvwig8MNFNbKnfWAPY/ofZRHAS+ry6DzM82Sje/70gKALkPDY/+NElCaXb' +
      'wCoCaXfx0wCSaenrTpNI2LM+sbBzkviC4+O4LEvjzsO2pHI+TAxNVqg/0/pml+9HzPqQhY',
  'ratifications': [{
    'head': 'Cn4KBXlhaG9vEMszGiCrUYYKackJHdA76UUDR7tMJwt77suZyJTi0khtJjArmSI' +
        'MCJ/S4rMFENDb6JgDKkCGcI173yhSDSO11xUkalK9HKeF7OTl8m/Y7QPp6JU/JKOxU9' +
        'gj0EvuuQlb0EvYmwfsXW8dq2QwGJqOxo+8oyw5MgASDAif0uKzBRDQ2+iYAw==',
    'signatures': {
      '5004056709842995553': 'WEArjKaPWitnJQ7crHhxO81v391PK995YD24yxMPQmqxco' +
          'mu2H0joomHJrLK6NNEFvSiKxcdhhTlJl0TI7g+DA=='
    }
  }, {
    'head': 'Cn4KBXlhaG9vEMszGiCrUYYKackJHdA76UUDR7tMJwt77suZyJTi0khtJjArmSI' +
        'MCJ/S4rMFENDb6JgDKkCGcI173yhSDSO11xUkalK9HKeF7OTl8m/Y7QPp6JU/JKOxU9' +
        'gj0EvuuQlb0EvYmwfsXW8dq2QwGJqOxo+8oyw5MgASDAif0uKzBRDQ2+iYAw==',
    'signatures': {
      '16574727844889599213': 'v3XY8JVb1FHE24c5vI4cDazh7A3FRWO/zhtyztqUTIeUr' +
          'Cbd++ZfWnufkOnmziWtxbm4Cv4W1HACItMCCoA1Ag=='
    }
  }, {
    'head': 'Cn4KBXlhaG9vEMszGiCrUYYKackJHdA76UUDR7tMJwt77suZyJTi0khtJjArmSI' +
        'MCJ/S4rMFENDb6JgDKkCGcI173yhSDSO11xUkalK9HKeF7OTl8m/Y7QPp6JU/JKOxU9' +
        'gj0EvuuQlb0EvYmwfsXW8dq2QwGJqOxo+8oyw5MgASDAif0uKzBRDQ2+iYAw==',
    'signatures': {
      '1702327623518731708': 'wH+3WGxS5oLTdYW1aH/Uhb8nIPAeYbRevLJmK6sA8HCArI' +
          'F2B4KOOwWzNqGp+unjlBDqIfjC0DcBHrfkpeuoDA=='
    }
  }],
  'tree_proof': {
    'neighbors': [
...
function testGetRealmByEmail() {
  ...
  goog.array.forEach(realm.verification_policy.quorum_list, function(id) {
    assertTrue(realm.verification_policy.public_keys[id].
...
function testDecodeLookupMessage() {
  ...
  function testDecodedMessage(lookupProof) {
    ...
    assertTrue(lookupProof.ratifications[0].
               signatures['5004056709842995553'].length > 0);
    assertTrue(lookupProof.ratifications[1].
               signatures['16574727844889599213'].length > 0);
    assertTrue(lookupProof.ratifications[2].
               signatures['1702327623518731708'].length > 0);
