...
function testDecodeLookupMessage() {
  ...
  client.initialize(function() {
    ...
    var lookupProof = e2e.coname.decodeLookupMessage_(this.proto, JSON.stringify(lookupProofSample));
    ...
    var lookupProofNoBody = e2e.coname.decodeLookupMessage_(this.proto, JSON.stringify(lookupProofNoBodySample));
